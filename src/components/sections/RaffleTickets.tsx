...
export default function RaffleTickets() {
    return (
        <Section id="raffle" title="Raffle Tickets">
            <div className="mx-auto max-w-2xl rounded-xl border border-lantern-400/30 bg-crimson-800/60 p-8 text-center">
                <p className="text-lg leading-relaxed text-warm-gold/90">
