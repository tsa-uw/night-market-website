...
> = {
    lantern: {
        ...
        iconBox:
            "border-lantern-400/15 bg-[rgba(251,184,72,0.07)] text-[rgba(251,184,72,0.7)]",
    ...
    blossom: {
        ...
        iconBox:
            "border-blossom-400/20 bg-[rgba(244,92,141,0.09)] text-blossom-300",
...
const INFO_CARDS: InfoCardData[] = [
    {
        ...
        body: (
            <>
                ...
                <strong className={em}>on the main stage</strong> at{" "}
                <strong className={em}>8:35 PM</strong> in Red Square. Winners
                must be present and show matching ticket to claim prize.
            </>
        ),
    },
    {
        ...
        body: (
            <>
                Purchase at the{" "}
                <strong className={em}>TSA Information Booth</strong> on the day
                of the event. Sales open at{" "}
                <strong className={em}>4:30 PM</strong> and close at{" "}
                <strong className={em}>8:00 PM</strong>.
            </>
        ),
    },
    {
...
const INFO_CARD_POSITIONS = ["sm:mt-0", "sm:mt-7", "sm:mt-3"];
        ...
        >
            ...
            <div className="pointer-events-none absolute inset-0 -z-20">
                ...
                <div
                    ...
                    style={{
                        background:
                            "linear-gradient(to bottom, rgba(6,9,16,0.05) 0%, rgba(6,9,16,0.30) 50%, rgba(6,9,16,0.65) 75%, rgba(6,9,16,0.85) 100%)",
                    }}
                />
            </div>
                            ...
                            <div className="relative flex overflow-hidden rounded-xl border border-[rgba(251,184,72,0.18)] bg-[rgba(8,13,24,0.82)] backdrop-blur-md">
                                ...
                                <div className="relative flex-1 overflow-hidden p-4 sm:p-7">
                                    ...
                                    <div className="relative mb-5 grid grid-cols-[1fr_minmax(74px,0.8fr)_1fr] items-end gap-2 sm:mb-4 sm:flex sm:items-center sm:gap-3">
                                        {/* FROM */}
                                        <div className="min-w-0">
                                            <div className="text-[9px] font-semibold uppercase tracking-[0.25em] text-[rgba(251,184,72,0.5)]">
                                                From
                                            </div>
                                            <div
                                            ...
                                            <div className="flex w-full items-center gap-1.5">
                                                <div
                                                    ...
                                                    style={{
                                                        height: "1px",
                                                        background:
                                                            "repeating-linear-gradient(to right, rgba(251,184,72,0.35) 0 4px, transparent 4px 8px)",
                                                    }}
                                                />
                                                <Plane
                                                    size={15}
                                                    className="text-lantern-400/70 -rotate-[10deg] shrink-0"
                                                    aria-hidden="true"
                                                />
                                                <div
                                                    className="flex-1"
                                        ...
                                        <div className="min-w-0 text-right">
                                            <div className="text-[9px] font-semibold uppercase tracking-[0.25em] text-[rgba(244,92,141,0.5)]">
                                                To
                                            </div>
                                            <div
                                    ...
                                    <div
                                        ...
                                        style={{
                                            background:
                                                "linear-gradient(90deg, transparent, rgba(251,184,72,0.2), transparent)",
                                        }}
                                    />
                                ...
                                <div
                                    ...
                                    style={{
                                        ...
                                        animation:
                                            "ticket-perforation-drift 3.8s linear infinite",
                                        boxShadow:
                                            "0 0 18px rgba(251,184,72,0.14)",
                                    }}
                                >
                                ...
                                <div className="relative hidden w-[120px] shrink-0 flex-col items-center justify-between gap-3 bg-[rgba(6,9,16,0.45)] px-4 py-7 sm:flex">
                                    <div
                                        ...
                                        style={{
                                            background:
                                                "linear-gradient(90deg, transparent, #fbb848, transparent)",
                                        }}
                                    />
                                    <span
                                ...
                                <div className="group relative h-full">
                                    ...
                                    <div className="relative h-full overflow-hidden rounded-none">
                                        ...
                                        <div className="relative flex h-11 items-center justify-between px-5">
                                            <span
                                                className={`text-[10px] font-semibold uppercase tracking-[0.2em] ${a.label}`}
                                            >
                                                Stub No. 0{i + 1}
                                            </span>
                                            <span
                                                className={`flex h-6 w-6 items-center justify-center rounded-none border ${a.iconBox}`}
                                            >
                                                <Icon
                                                    size={13}
                                                    aria-hidden="true"
                                        ...
                                        />
                                        <div
                                            className={`absolute -left-1.5 top-11 h-3 w-3 -translate-y-1/2 rounded-full border bg-night-900 ${a.notch}`}
                                        />
                                        <div
                                            className={`absolute -right-1.5 top-11 h-3 w-3 -translate-y-1/2 rounded-full border bg-night-900 ${a.notch}`}
                                        />

                                        {/* Stub body */}
                                        <div className="relative px-5 pb-5 pt-4">
                                            <div
                                                className={`mb-1.5 text-base font-semibold ${a.title}`}
                                            >
                                                {title}
                                            </div>
