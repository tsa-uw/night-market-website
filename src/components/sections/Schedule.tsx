...
const SCHEDULE_EVENTS: ScheduleEvent[] = [
    ...
    { time: "6:27 PM", title: "Remi Vernon",                              type: "Music",        desc: "Singer-songwriter Remi Vernon takes the stage for a captivating live performance. Expect soulful melodies and heartfelt lyrics." },
